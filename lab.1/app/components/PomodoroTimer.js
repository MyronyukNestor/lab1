...
class PomodoroTimer extends React.Component {
	...
	handleWorkTime = (text) =>
	{
		if(text >= 0)
		{
			...
			alert("Час недійсний. Встановлення значення за умовчанням. Введіть дійсний час")
			this.setState({
				workTime: 25
			})
		}
